            ...
            child: ClipRRect(
              ...
              child: SfCalendar(
                ...
                monthCellBuilder: (BuildContext context, MonthCellDetails details) {
                  ...
                  final bool hasEventSurgery = _appointments.any((Appointment2
                  appointment) =>
                  appointment.appointmentDate != null &&
                      details.date.day == appointment.appointmentDate!.day &&
                      details.date.month == appointment.appointmentDate!.month &&
                      details.date.year == appointment.appointmentDate!.year &&
                      appointment.apptmType == 'Cirugía');
                  ...
                  int eventCountSurgery = _appointments.where((appointment) =>
                  appointment.appointmentDate != null &&
                      appointment.appointmentDate!.day == details.date.day &&
                      appointment.appointmentDate!.month == details.date.month &&
                      appointment.appointmentDate!.year == details.date.year &&
                      appointment.apptmType == 'Cirugía').length;
                  ...
                  final bool hasevent = hasEventGral || hasEventEstetic || hasEventSurgery;
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        EventCounterCircle(
                                          count: eventCountGral,
                                          backgroundColor: AppColors3.whiteColor,
                                          isInCurrentMonth: true, // Siempre true para este caso
                                          context: context,
                                          textColor: AppColors3.primaryColor,
                                          borderColor: AppColors3.primaryColor,
                                        ),
                                        EventCounterCircle(
                                          count: eventCountEstetic,
                                          backgroundColor: AppColors3.secundaryColor,
                                          isInCurrentMonth: true, // Siempre true por ser TODAY
                                          context: context,
                                          textColor: AppColors3.whiteColor,
                                          borderColor: AppColors3.primaryColor,
                                        )])),
                              Align(
                                  alignment: Alignment.topRight,
                                  child: EventCounterCircle(
                                    count: eventCountSurgery,
                                    backgroundColor: AppColors3.redDelete,
                                    isInCurrentMonth: true, // Siempre true por ser TODAY
                                    context: context,
                                    textColor: AppColors3.whiteColor,
                                    borderColor: AppColors3.redDelete,
                                  ))]));
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: EventCounterCircle(
                                    ...
                                    context: context,
                                    textColor: AppColors3.whiteColor,
                                    borderColor: AppColors3.blackColor,
                                  ))
                            ]));
                  } else {
                    return Container(
...
class EventCounterCircle extends StatelessWidget {
  final int count;
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(
              ...
              color: isInCurrentMonth
                  ? textColor
                  : AppColors3.greyColor.withOpacity(0.6),
            ),
          ),
        ),
      ),
